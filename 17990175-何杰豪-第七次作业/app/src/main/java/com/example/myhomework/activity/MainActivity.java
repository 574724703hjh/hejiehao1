...
import com.example.myhomework.been.UserInfo;
import com.example.myhomework.database.UserDBHelper;
import com.example.myhomework.util.DateUtil;
import com.example.myhomework.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"清华大学", "教师用户", "17990175-何杰豪"};
