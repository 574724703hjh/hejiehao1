...
import com.example.myhomework.activity.Main2Activity;
...
public class ShoppingCartFragment extends Fragment implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        gp_content = view.findViewById(R.id.gp_content);
        ll_cart = view.findViewById(R.id.ll_cart);
        gp_empty = view.findViewById(R.id.gp_empty);
    ...
    private void showCart() {
        ...
        for (int i = 0; i < mCartArray.size(); i++) {
            ...
            LinearLayout.LayoutParams iv_params = new LinearLayout.LayoutParams(
                    0, Utils.dip2px(getActivity(), 85), 2);
